...
HD_PWD='C:/Users/Caio Lacerda/Desktop/exp_vivado/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log experimento4_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source experimento4_top.tcl -notrace
