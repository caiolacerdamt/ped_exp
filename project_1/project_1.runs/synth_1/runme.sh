...
HD_PWD='C:/Users/Caio Lacerda/Desktop/exp_vivado/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log experimento4_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source experimento4_top.tcl
